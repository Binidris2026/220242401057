...
As a result, the term becomes generalized to represent the entire
end‑to‑end knowledge discovery pipeline.



## 2. Differences between data wrangling, scanning, and filtering in data mining

### **Data Wrangling**

Data wrangling (or data cleaning) is the process of transforming raw
...
Scanning is the process of quickly reviewing large datasets to identify
patterns, anomalies, or areas that need deeper analysis.

**Key Points:**
- Provides a broad overview
- Helps detect outliers or unusual trends
- Often used as an exploratory step



### **Filtering**

Filtering is the process of selecting specific data based on conditions
or criteria.
